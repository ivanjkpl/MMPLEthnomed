...
class __TwigTemplate_0f8f42f92d1441a31cdef9a2ef0cec2b extends Template
{
    ...
    ";
            ...
            if (CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "content", [], "any", false, false, true, 25)) {
                // line 26
                yield "      <div";
                yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, CoreExtension::getAttribute($this->env, $this->source, ($context["description"] ?? null), "attributes", [], "any", false, false, true, 26), "addClass", ["description"], "method", false, false, true, 26), "html", null, true);
                yield " >";
...
";
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/adaptivetheme/at_core/templates/form/field-multiple-value-form.html.twig", "C:\\xampp\\htdocs\\mmpl\\web\\themes\\contrib\\adaptivetheme\\at_core\\templates\\form\\field-multiple-value-form.html.twig");
    }
